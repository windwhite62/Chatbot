...
def chat():
    ...
    if OFF_TOPIC.search(msg):
        return jsonify({"answer": "Je suis uniquement disponible pour répondre aux questions concernant la ville de Lambersart.", "sources": []}), 200
